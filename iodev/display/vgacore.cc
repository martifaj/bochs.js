...
*/
  ...
  if (BX_VGA_THIS s.sequencer.map_mask & 0x0f) {
    bx_bool vmem_updated = 0;
    if ((BX_VGA_THIS s.sequencer.map_mask & 0x01) && plane0[offset] != new_val[0]) {
      vmem_updated = 1;
      plane0[offset] = new_val[0];
    }
    if ((BX_VGA_THIS s.sequencer.map_mask & 0x02) && plane1[offset] != new_val[1]) {
      vmem_updated = 1;
      plane1[offset] = new_val[1];
    }
    if ((BX_VGA_THIS s.sequencer.map_mask & 0x04) && plane2[offset] != new_val[2]) {
      vmem_updated = 1;
    ...
    if ((BX_VGA_THIS s.sequencer.map_mask & 0x08) && plane3[offset] != new_val[3]) {
      vmem_updated = 1;
